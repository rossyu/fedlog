...
if DATASET == "mnist":
    ...
    params.path = "./res/communication_cost/mnist/fedavg_"+str(SEED)+"_"
    ...
    fedlog_model = CNNMnist(body=body_init, fc1=head_init.fc1, fc2=head_init.fc2, augment=False)
    exp.register_model("FedAvg", FedAvg, 
            FedAvg.Parameters(model=fedlog_model, num_class=10, num_clients=NUM_CLIENTS,
    ...
    params.global_epochs = 100
    params.pretrain = True
    params.path = "./res/communication_cost/cifar10/fedavg_"+str(SEED)+"_"
    exp = Experiment(params)
    ...
    fedlog_model = CNNCifar(body=body_init, fc2=head_init.fc2, fc3=head_init.fc3, augment=False)
    exp.register_model("FedAvg", FedAvg,
            FedAvg.Parameters(model=fedlog_model, num_class=10, num_clients=NUM_CLIENTS,
    ...
    params.pretrain = True
    params.path = "./res/communication_cost/cifar100/fedavg_"+str(SEED)+"_"
    exp = Experiment(params)
    ...
    fedlog_model = CNNCifar(body=body_init, fc2=head_init.fc2, fc3=head_init.fc3, augment=False)
    exp.register_model("FedAvg", FedAvg,
            FedAvg.Parameters(model=fedlog_model, num_class=100, num_clients=NUM_CLIENTS,
