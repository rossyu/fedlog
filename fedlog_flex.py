...
from model.fedlogflex import FedLog
...
def build_cifar10_body2():
    ...
    fedlog_model = CNNCifar(body=body_init, augment=True)
    return fedlog_model
...
if DATASET == "cifar10":
    ...
    params.path = "./res/flex/cifar10/fedlog_"+str(SEED)+"_"
    ...
    exp.register_model("FedLog",FedLog,
            FedLog.Parameters(model=[build_cifar10_body1, build_cifar10_body2],
                m=100, num_class=10, num_clients=NUM_CLIENTS,
