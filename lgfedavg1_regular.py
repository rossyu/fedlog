...
if DATASET == "mnist":
    ...
    params.path = "./res/communication_cost/mnist/lgfedavg1_"+str(SEED)+"_"
    ...
    lg_model_1layer = CNNMnist(body=body_init, fc1=head_init.fc1, augment=False)
    exp.register_model("LG-FedAvg 1", LGFedAvg,
            LGFedAvg.Parameters(local_model=lg_model_1layer, global_model=head_init.fc2,
    ...
    params.global_epochs = 100
    params.pretrain = True
    params.path = "./res/communication_cost/cifar10/lgfedavg1_"+str(SEED)+"_"
    exp = Experiment(params)
    ...
    lg_model_1layer = CNNCifar(body=body_init, fc2=head_init.fc2, augment=False)
    exp.register_model("LG-FedAvg 1", LGFedAvg,
            LGFedAvg.Parameters(local_model=lg_model_1layer, global_model=head_init.fc3,
    ...
    params.pretrain = True
    params.path = "./res/communication_cost/cifar100/lgfedavg1_"+str(SEED)+"_"
    exp = Experiment(params)
